...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_experiment', type=int, help='Which experiment you want to run [1-8]')

    args = parser.parse_args()

    # ------------------------------ IMDB DATABASE EXPERIMENT ------------------------------
    ...
    # args = op_ssb_opt.aqp_ground_truth_queries(explain=False)
